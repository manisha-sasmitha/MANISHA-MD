...
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/te4oxi.jpg` }, caption: up })
...
//=========OWNER - REACTION ===============================  
if(senderNumber.includes("94783097853")){
if(isReact) return
m.react("👨🏻‍💻")
}
if(senderNumber.includes("94785598345")){
if(isReact) return
m.react("👨🏼‍💻")
}
if(senderNumber.includes("94723289795")){
if(isReact) return
m.react("👩🏽‍💻")
}
if(senderNumber.includes("94711353412")){
if(isReact) return
m.react("👾")
}
